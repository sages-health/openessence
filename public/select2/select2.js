/*!
 * Based on select2 v3.4.6:
 * https://github.com/ivaynberg/select2/tree/df7b7ba95ce61f7ec292f108ff366ae1024ae103
 *
 * Copyright 2012 Igor Vaynberg
 * Licensed under Apache 2.0 or GPL 2.0:
 * https://github.com/ivaynberg/select2/blob/master/LICENSE
 */
'use strict';
      ...
      opts.initSelection = opts.initSelection || function (element, callback) {
        ...
        opts.query({
          matcher: function (term, text, el) {
            var isMatch = equal(id, opts.id(el));
            if (isMatch) {
              match = el;
            }
            return isMatch;
...
MultiSelect2 = clazz(AbstractSelect2, {
  ...
  initContainer: function () {
    ...
    this.search.on("keydown", this.bind(function (e) {
      ...
      if (selected.length &&
        (e.which === KEY.LEFT || e.which === KEY.RIGHT || e.which === KEY.BACKSPACE || e.which === KEY.DELETE ||
          e.which === KEY.ENTER)) {
  ...
  addSelectedChoice: function (data) {
    var enableChoice = !data.locked,
      enabledItem = $(
          ...
          "    <div></div>" +
          // patched to use icon-remove instead of image sprite
          "    <a href='#' class='select2-search-choice-close' tabindex='-1'><span class='icon-cancel'></span></a>" +
          "</li>"),
      disabledItem = $(
...
$.fn.select2.defaults = {
  ...
  shouldFocusInput: function (instance) {
    ...
    return instance.opts.minimumResultsForSearch >= 0;
  }
};
