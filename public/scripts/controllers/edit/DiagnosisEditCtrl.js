...
angular.module(controllers.name).controller('DiagnosisEditCtrl', function ($scope, $modal, orderByFilter, gettextCatalog, FrableParams, Diagnosis, sortString, $rootScope) {
  $scope.filters = [
    {filterId: 'name'}
  ];
  $scope.filterTypes = [
