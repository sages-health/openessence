...
var typeId = 'diagnosis';
var typeName = 'Diagnosis';
...
angular.module(controllers.name).controller('DiagnosisEditCtrl', function ($scope, $http, gettext, gettextCatalog, orderByFilter, FrableParams, $rootScope, $modal) {
