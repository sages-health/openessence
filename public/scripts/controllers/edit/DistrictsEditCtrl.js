...
angular.module(controllers.name).controller('DistrictsEditCtrl', function ($scope, $http, gettext, gettextCatalog, orderByFilter, FrableParams, $rootScope, $modal) {
